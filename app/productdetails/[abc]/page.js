        ...
        <div className="wrapper row">
          <div className="preview col-md-6">
            <div className="preview-pic tab-content">
              <Zoom>
              <div className="tab-pane active" id="pic-1"><img src={'/'+ad.src} /></div>   
...
Running sneakers offer lightweight design, breathable mesh uppers, and cushioned midsoles for shock absorption, providing comfort and support during long runs.
            </p>
            <h4 className="price">
            ...
            <div className="action">
              ...
              }} className="cartBtn add-to-cart btn btn-default" type="button">
                add to cart
              </button>
